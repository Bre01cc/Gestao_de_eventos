...
-- ------------------------------------------------------------
create database db_gestao_eventos_ds2m;

use db_gestao_eventos_ds2m;
-- ------------------------------------------------------------
--  1)CRIAÇÃO DA TABELA DE ORGANIZADOR
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 2)CRIAÇÃO DA TABELA DE PARTICIPANTE
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 4) CRIAÇÃO DA TABELA DE CATEGORIA DO EVENTO
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 5)CRIAÇÃO DA TABELA DE STATUS DO EVENTO
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 6) CRIAÇÃO DA TABELA DE FORMA DE PAGAMENTO
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 7) CRIAÇÃO DA TABELA DE TIPOS DE INGRESSO
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 8) CRIAÇÃO DA TABELA RELACIONAMENTO EVENTO E ENDEREÇO
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 9) CRIAÇÃO DA TABELA RELACIONAMENTO PARTICIPANTE E ENDEREÇO
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 10) CRIAÇÃO DA TABELA RELACIONAMENTO ORGANIZADOR E ENDEREÇO
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 11) CRIAÇÃO DA TABELA DE EVENTOS
-- ------------------------------------------------------------
CREATE TABLE tb_evento (
    ...
    CONSTRAINT fk_evento_status
        FOREIGN KEY (id_status_evento) REFERENCES tb_status_evento(id),
    CONSTRAINT fk_evento_endereco
        FOREIGN KEY (id_endereco_evento) REFERENCES tb_endereco_evento(id)
);

-- ------------------------------------------------------------
-- 12) CRIAÇÃO DA TABELA DE SETORES DO EVENTO
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 13) CRIAÇÃO DA TABELA RELACIONAMENTO ENTRE EVENTO E CATEGORIA
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 14) CRIAÇÃO DA TABELA DE LOTE DE INGRESSOS
-- ------------------------------------------------------------
CREATE TABLE tb_lote_ingresso (
    ...
    CONSTRAINT fk_lote_tipo
        FOREIGN KEY (id_tipo) REFERENCES tb_tipo_ingresso(id)
);

-- ------------------------------------------------------------
-- 15) CRIAÇÃO DA TABELA PEDIDO
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 16) CRIAÇÃO DA TABELA DE INGRESSOS DO PEDIDO
-- ------------------------------------------------------------
CREATE TABLE tb_ingressos_pedido (
    ...
    CONSTRAINT fk_ingressos_pedido_lote
        FOREIGN KEY (id_lote_ingresso) REFERENCES tb_lote_ingresso(id),
